...
properties.each_with_index do |property, index|
  image_path = File.join(Rails.root, "app/assets/images/photo (#{index + 1}).jpg")
  property.image.attach(io: File.open(image_path), filename: "photo (#{index + 1}).jpg", content_type: 'image/jpeg')
  sleep(1) # Add a sleep to reduce concurrency
end